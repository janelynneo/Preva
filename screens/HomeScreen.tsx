          ...
          <>
            <View style={styles.baselineCard}>
              ...
              <View style={styles.progressContainer}>
                <View style={styles.progressBar}>
                  <View
                    style={[styles.progressFill, { width: `${baselineProgress}%` }]}
                  />
                </View>
            ...
            <View style={styles.insightCard}>
              ...
              <Text style={styles.insightText}>
                Singapore desk workers who take a 10-minute walk after lunch
                report 23% better afternoon energy levels.
              </Text>
          ...
          <>
            ...
            {dayState === 'full' && (
              ...
              >
                <View style={styles.mwiBannerContent}>
                  ...
                  <Text style={styles.mwiBannerValue}>
                    Tier 2 🟡
                  </Text>
                </View>
            ...
            <View style={styles.recoveryCard}>
              ...
              <View style={styles.recoveryStats}>
                ...
                <View style={styles.recoveryStat}>
                  <Text style={styles.recoveryValue}>{recoveryData.sleep}%</Text>
